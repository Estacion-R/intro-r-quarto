...
-   **Población económicamente activa:** Aquellas personas que tienen o que están buscando activamente una ocupación (población ocupada + desocupada)
...
![](images/condicion%20de%20actividad.png){width="20%"}
...
-   **Actividad (rama):** [Clasificador de Actividades para Encuestas Sociodemográficas (CAES-MERCOSUR)](https://www.indec.gob.ar/ftp/cuadros/menusuperior/clasificadores/notas_explicativas_caes_v2018.pdf)

-   **Ocupación:** [Clasificador Nacional de Ocupaciones (CNO-2001-INDEC)](https://www.indec.gob.ar/ftp/cuadros/menusuperior/clasificadores/definiciones_conceptuales_cno.pdf)
