...
a.  Estoy necesitando quedarme con los casos de tipo *Parahoteleros*. Reemplazar el campo ´_______´ de la siguiente sentencia y comprobar que la operación fué exitosa:
...
a.  Estoy necesitando quedarme con los casos de tipo *Parahoteleros*. Reemplazar el campo ´______´ de la siguiente sentencia y comprobar que la operación fué exitosa:
