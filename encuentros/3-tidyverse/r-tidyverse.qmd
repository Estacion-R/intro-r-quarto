...
## `select()` - _por posición (columnas consecutivas)_
...
## `select()` - _por nombre (consecutiva)_
...
## `select()` - _Por patrones de texto_

<br>

**Trío: **

- `starts_with()`  --> _empieza con..._

- `ends_with()` --> _termina con..._

- `contains()` --> _contiene..._
