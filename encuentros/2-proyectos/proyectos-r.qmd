...
> [Link](https://drive.google.com/file/d/1uyvbLLzvr2qbjIv33XokxmdUJNK26i8b/view?usp=sharing)
...
read_csv(file = "C:/Users/Federico/Downloads/nombres-2015.csv")
```
...
``` r
base_personas <- read_csv(file = "C:/Users/Federico/Downloads/nombres-2015.csv")
```
