...
-   Es un lenguaje de programación, un diccionario que permite comunicarnos para realizar ciertas tareas.
-   Su enfoque principale es el procesamiento, análisis y la comunicación de datos
