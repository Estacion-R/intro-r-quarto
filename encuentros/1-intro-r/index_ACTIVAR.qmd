---
title: "Bienvenido a Estación R"
subtitle: "2:05 - 2:25"
author: Mine Çetinkaya-Rundel
image: featured.png
description: Bienvenida al espacio y al curso.
---

## Abstract

Estación R es bla bla bla

## Slides

```{=html}
<iframe class="slide-deck" src="/talks/1-intro-r/intro-r.html" height="420" width="747" style="border: 1px solid #2e3846;"></iframe>
```
## Links
