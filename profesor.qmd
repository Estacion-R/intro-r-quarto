...
📝 Podés encontrar parte de mi recorrido y trabajo con R en mi blog personal [estación-R](https://estacion-r.netlify.app/), buscar Tips sobre R con [rtips](https://twitter.com/r_tipss) y descubrir [Asombrosos paquetes de R en Latinoamérica](https://github.com/pablotis/asombrosos-paquetes-r-latinoamerica), proyectos que llevo adelante como aporte a la comunidad.

Podemos cruzarnos en: [𝕏 r_tips](https://twitter.com/r_tips) \| [Github](https://github.com/pablotis) \| [🌐 estacion-r](https://estacion-r.netlify.app/) \| [𝕏 pabblo_h](https://twitter.com/pabblo_h)
